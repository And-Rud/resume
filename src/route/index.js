...
var footer = {
  social: {
    ...
    linkedin: {
      text: 'LinkedIn',
      href: 'https://www.linkedin.com/ivanov.ivan',
    },
  },
}
// ================================================================
    ...
    main: {
      summary: {
        ...
        text: `Open-minded for new technologies, with 1 years of experience in
			development. Whenever I start to work on a new project I learn the domain and 
			try to understand the idea of the project. Good team player, every colleague is
			 a friend to me.`,
      },
      experience: {
...
router.get('/skills', function (req, res) {
  ...
  res.render('skills', {
    ...
    main: {
      title: 'All skills',
      skills: [
        { name: 'HTML & CSS', point: 9, isTop: true },
        { name: 'VSCode & NPM', point: 9, isTop: true },
        { name: 'GIT & Terminal', point: 8, isTop: false },
        { name: 'Handlebars', point: 9, isTop: false },
        { name: 'React.js', point: 0, isTop: false },
        { name: 'PHP', point: null, isTop: false },
      ],
      hobbies: [
        { name: 'Bicycles', isMain: true },
        { name: 'Traveling', isMain: false },
        { name: 'Motobike', isMain: true },
      ],
    },
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        { name: 'School #3', isEnd: false },
        { name: 'NTUU KPI', isEnd: true },
        { name: 'IT Brains', isEnd: true },
      ],
      certificates: [
        { name: 'Courses PM&HR', id: 123 },
        { name: 'Courses Stabilites', id: 337 },
        { name: 'Courses FullStack ', id: 557 },
      ],
    },
...
router.get('/shopnews', function (req, res) {
  ...
  res.render('shopnews', {
    ...
    newsData: {
      photo: 'https://picsum.photos/950/475',
